...
async def predict_and_advise(file: UploadFile = File(...)):
    try:
        ...
        Lưu ý: Bắt buộc phải có một câu rào trước rằng đây chỉ là chẩn đoán tham khảo từ AI, bệnh nhân cần đến phòng khám nha khoa để bác sĩ kiểm tra và chụp chiếu lại.
        """
